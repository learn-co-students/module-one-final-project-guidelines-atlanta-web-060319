...
lumbrzach = User.create(username: "lumbrzach", age:31)
hamallday = User.create(username: "Hamallday", age:32)
king = User.create(username: "king_of_cons", age:37)
parkercita = User.create(username: "parkercita", age:33)
sjp = User.create(username: "sjp", age:21)
